...
def train(model,data_loader,data_loader_v,loss_func,callbacks=None,pretrained=None,lr=0.0,epoch=100):
    ...
    loaders = {
        "train": DataLoader(data_loader,batch_size=256,
                            ...
                            pin_memory=True,
                            drop_last=False),
        "valid":DataLoader(data_loader_v,batch_size=4096*50,
                            shuffle=False,
                            num_workers=4,
                            pin_memory=True,
                            drop_last=False)}
...
if __name__ == "__main__":
    ...
    identifier='rad_stan_'
    pickle_jar = [config.data_loc + 'from_radar/' + identifier+'devdict1.pkl', config.data_loc + 'from_radar/' + identifier+ 'devdict2.pkl']
    data_loader=data_loader_(group=pickle_jar, n_skill=4, max_seq=13, dev=True)
    pickle_jar = [config.data_loc + 'from_radar/' + identifier+ 'hold_outdict1.pkl', config.data_loc + 'from_radar/' + identifier+ 'hold_outdict2.pkl']
    ...
    pretrained=config.weight_loc+'transformer_v1_12.pth'
